...
R is available from [http://www.R-project.org](http://www.R-project.org). To run this model, R  
package deSolve is required.

Here is a screen shot of the model running supplied by the model  
authors:

![screenshot](./HH-test.jpg)
...
[ModelDB accession number 137263](http://senselab.med.yale.edu/ModelDB/ShowModel.asp?model=137263)
